...
// 收货地址
Route::resource('member_address', \Mano\Crm\Http\Controllers\MemberAddresController::class);
...
// 搜索用户
Route::any('/mini-wechat/member',[\Mano\Crm\Http\Controllers\MemberAddresController::class,'getMember']);
